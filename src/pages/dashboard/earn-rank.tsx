...
const data = [
  { label: "VENIAM", value: 25 },
  { label: "CILLUM", value: 20 },
  { label: "LABORE", value: 15 },
  { label: "TEMPOR", value: 10 },
  { label: "ALIQUA", value: 5 },
];
  ...
  return (
    <Card sx={{ 
      ...
      <CardContent sx={{ padding: 2, background: "linear-gradient(90deg, #39203dDD, #331e3fDD)", height: "100%" }}>
        <Box sx={{width: "100%"}}>
          <TopDownBarChart data={data} textPadding={100} barColor='#359bb2' barHeight={30} fontSize='14px' rightTextPadding={140}/>
        </Box>
      </CardContent>
    </Card>
  );
